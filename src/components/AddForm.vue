...
<script>
import BaseColorOptions from './BaseColorOptions'

export default {
    components: {BaseColorOptions},
    data () {
        return {
            searchRadius: 1,
            wasteType: [],
